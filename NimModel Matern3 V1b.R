NimModel <- nimbleCode({
  ...
  #zeros-trick, z[1:N.secondary] is data, indicating the point was retained as a secondary point
  dummy.data3[1:N.secondary] ~ dThin(D1=D1[1:N.secondary,1:N.secondary],D.cross=D.cross[1:N.secondary,1:M],
                            age1=age1[1:N.secondary],age2=age2[1:M],r=r,N.thin=N.thin) #z is "retain"
